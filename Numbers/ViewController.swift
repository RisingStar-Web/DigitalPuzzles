...
enum ComplexityEnum: UInt8 {
    ...
    func liderBoard() -> String {
        ...
        case .forDigits:
            return "grp.dp_4d"
        case .square:
            return "grp.dp_square_2x2"
        case .rectangle:
            return "grp.dp_rectangle_2x3"
        case .bigSquare:
            return "grp.dp_square_3x3"
        }
    }
}
...
class ViewController: UITableViewController, GKGameCenterControllerDelegate {
    ...
    var menuItems:[String] = [localized("Start"), localized("Rules"), localized("Modes"), localized("High Scores")]
...
//        imageView.alpha = 0.7
    ...
    @objc func expand() {
        ...
        if  (menuExpanded) {
            ...
            menuItems = [localized("Start"), localized("Rules"), localized("Modes"), localized("2 digits"), localized("3 digits"),
                localized("4 digits"), localized("Line"), "2х2" , "2х3", "3х3", localized("High Scores")]
        } else {
            menuItems = [localized("Start"), localized("Rules"), localized("Modes"), localized("High Scores")]
        }
    ...
    @objc func otherApps () {
        UIApplication.shared.openURL(URL(string: "https://itunes.apple.com/us/developer/gadget-easy-soft/id486068118?mt=8")!)
    }
